...
class OwnerFacade(Protocol):
    ...
    looked up through the dependency container. Injecting it as a port keeps the
    car module's domain free of container imports.
    """

    def get_owner_by_id(self, **kwargs) -> Any: ...
